...
run_map()
# step_size = 0.5
# clear_dist  = step_size/2**.5
# theta = (180*math.acos(math.sqrt(2*(step_size**2) - clear_dist)/(2*(step_size**2))))/math.pi
# print(theta)